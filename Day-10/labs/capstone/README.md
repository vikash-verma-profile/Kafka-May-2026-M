...
- **Kubernetes option:** deploy with Strimzi ([Lab 02](../lab-02-kubernetes-strimzi/README.md)); connect via `localhost:30094` after running [start-strimzi-port-forwards.bat](../scripts/start-strimzi-port-forwards.bat)
