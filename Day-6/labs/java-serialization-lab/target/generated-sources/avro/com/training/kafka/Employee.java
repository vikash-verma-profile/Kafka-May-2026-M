...
public class Employee extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6670816236924776976L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Employee\",\"namespace\":\"com.training.kafka\",\"fields\":[{\"name\":\"id\",\"type\":\"int\"},{\"name\":\"name\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"dept\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"salary\",\"type\":\"double\"}]}");
   ...
   */
  public Employee(java.lang.Integer id, java.lang.String name, java.lang.String dept, java.lang.Double salary) {
    this.id = id;
    this.name = name;
    this.dept = dept;
    this.salary = salary;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: dept = value$ != null ? value$.toString() : null; break;
   ...
   */
  public static com.training.kafka.Employee.Builder newBuilder() {
    return new com.training.kafka.Employee.Builder();
  }
   ...
   * @return A new Employee RecordBuilder
   */
  public static com.training.kafka.Employee.Builder newBuilder(com.training.kafka.Employee.Builder other) {
    if (other == null) {
      return new com.training.kafka.Employee.Builder();
    } else {
      return new com.training.kafka.Employee.Builder(other);
    }
  }
   ...
   * @return A new Employee RecordBuilder
   */
  public static com.training.kafka.Employee.Builder newBuilder(com.training.kafka.Employee other) {
    if (other == null) {
      return new com.training.kafka.Employee.Builder();
    } else {
      return new com.training.kafka.Employee.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Employee>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.training.kafka.Employee.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.training.kafka.Employee other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.training.kafka.Employee.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.training.kafka.Employee.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.training.kafka.Employee.Builder setName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.training.kafka.Employee.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.training.kafka.Employee.Builder setDept(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.training.kafka.Employee.Builder clearDept() {
      dept = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.training.kafka.Employee.Builder setSalary(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.training.kafka.Employee.Builder clearSalary() {
    ...
    public Employee build() {
      try {
        ...
        record.dept = fieldSetFlags()[2] ? this.dept : (java.lang.String) defaultValue(fields()[2]);
